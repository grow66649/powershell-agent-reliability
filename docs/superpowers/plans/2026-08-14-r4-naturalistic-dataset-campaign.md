...
- Base/spec HEAD: `8afe3a002987afb6a6159e2e1a0f0780a7f9d6d7` on `docs/r4-naturalistic-dataset-campaign-20260814`.
...
git diff --check
git status --short
git diff --name-only 8afe3a002987afb6a6159e2e1a0f0780a7f9d6d7..HEAD
```
